...
struct ModelParams {
  ...
  std::string custom_model_key = ""; // Key of a previously created model
...
struct ModelUpdateParams {
  ...
  std::optional<bool> receive_lighting{}; /// Enable or not the lightning shader
                                          /// on the model materials
};

/**
 * @brief Primitive types available to create custom models
 */
